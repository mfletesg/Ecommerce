...
<div className="row mt-3 text-white footer">
  ...
  <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
    ...
    <p className="small">
      <i className="fas fa-home mr-3"></i> 321, Ramis Gandour Colony, District 9 Florida</p>
    <p className="small">
      <i className="fas  fa-phone mr-3"></i> 090-0965-2987</p>
    <p className="small">
      <i className="fas fa-mail mr-3"></i> contact@company.com</p>
  ...
  <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
    ...
    <h6 className="text-uppercase " style={{textDecorationLine: 'underline'}}>SUBSCRIBE FORM MORE UPDATES</h6>
    <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{width: '60px'}} />

    <p className="small">Sing up for Newsletter to Get all the information on Events, Offers, Sales and More</p>
  ...
  <div className="footer-copyright text-center py-3 footer-color2 text-white">Copyright © 2018. Company All Rights Reserved
  </div>
